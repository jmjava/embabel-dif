...
| [ORCH_INTEGRATION_ROADMAP.md](ORCH_INTEGRATION_ROADMAP.md) | **How it enters a developer’s day.** Architect/review attach, daily loop, Dashboard readout, and the integration test ladder. |
